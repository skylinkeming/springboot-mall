...
public class OrderController {
    ...
    public ResponseEntity<Page<Order>> getOrders(@PathVariable Integer userId, @RequestParam(defaultValue = "10") @Min(0) Integer limit, @RequestParam(defaultValue = "0") @Min(0) Integer offset) {
